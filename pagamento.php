                    ...
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px; padding-top: 20px;">

                                    <div id="btn-pagar"></div>

                                    <?php
                                    require_once "NewPreferenceRequest.php";
                                    ...
                                    require_once "BackUrls.php";
                                    require_once "restclient.php";
                                    require_once "NewPreferenceResponse.php";
                                    ...
                                    $payer = new Payer(
                                        ...
                                        new Phone("55", "98529-8743"),
                                        null,//new Identification("725762927", "cpf"),
                                        new Address("78134-190", "Insurgentes Sur", 1602)
                                    );

                                    //MÉTODOS DE PAGAMENTO
                                    $paymentMethods = new PaymentMethods(6);
                                    $paymentMethods->addExcludedPaymentMethod(new PaymentMethod("amex"));
                                    ...
                                    $headers['Authorization']   = 'Bearer APP_USR-334491433003961-030821-12d7475807d694b645722c1946d5ce5a-725736327';
                                    ...
                                    $result = $api->execute(
                                        ...
                                        "POST",
                                        json_encode($preference),
                                        $headers
                                    );

                                    $newPreferenceResponse = new NewPreferenceResponse();

                                    $newPreferenceResponse = json_decode($result->response);
                                    ...
                                    <script>
                                        ...
                                        mp.checkout({
                                            preference: {
                                                id: '<?=$newPreferenceResponse->id?>'
                                            },
                                            render: {
                                                container: '#btn-pagar', // Indica onde o botão de pagamento será exibido
