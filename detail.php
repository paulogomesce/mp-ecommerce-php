                ...
                <div id="accessories-tab" class="as-accessories-details">
                    <div class="as-accessories" id="as-accessories">
                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                <div class="as-producttile-tilehero with-paddlenav " style="float:left; display:inline;">                                   
                                ...
                                <div class="as-producttile-info" style="float:right; min-height: 168px; display: inline;">
                                    <div class="as-producttile-titlepricewraper" style="min-height: 128px;">
                                        <div class="as-producttile-title">
                                            <h3 class="as-producttile-name">
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">Nome: <?php echo $_POST['title'] ?></span>
                                                </p>
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">Descrição: <?php echo $_POST['description'] ?></span>
                                                </p>
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">Preço: <?php echo $_POST['price'] ?></span>
                                                </p>
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">Quantidade: <?php echo $_POST['unit'] ?></span>
                                                </p>
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">Nome: <?php echo $name?></span>
                                                </p>
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">E-mail: <?php echo $email ?></span>
                                                </p>
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">Telefone: <?php echo $area_code." - ".$number?></span>
                                                </p>
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">CEP: <?php echo $zip_code ?></span>
                                                </p>
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">Rua: <?php echo $street_name ?></span>
                                                </p>
                                                <p class="as-producttile-tilelink">
                                                    <span data-ase-truncate="2">Número: <?php echo $street_number ?></span>
                                                </p>
                                    ...
                                    <form method="POST" action="pagamento.php">
                                        ...
                                        <input type="hidden" name="external_reference" value="<?=$_POST["external_reference"]?>">
