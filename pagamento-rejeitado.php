                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px; padding-top: 20px;">
                                    <?php
                                        echo "<h3>O pagamento foi recusado!</h3>";
                                        echo "<p>Tente outra forma de pagamento.</p>";
                                    ?>
                                    <form action="https://www.mercadopago.com.br/checkout/v1/redirect?pref_id=<?=$_GET["preference_id"]?>" target="_blank">
                                        <button type="submit" class="mercadopago-button" formmethod="post">Tentar Pagar de Outra Forma</button>
                                    </form>
