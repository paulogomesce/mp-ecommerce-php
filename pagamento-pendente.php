                        ...
                        <div class="as-accessories-results  as-search-desktop">
                            <div class="width:60%">
                                ...
                                <div class="as-producttile-info" style="float:left;min-height: 168px; padding-top: 20px;">
                                    <?php
                                        echo "<h3>Estamos processando seu pagamento!</h3>";
                                        echo "<h4>O que eu posso fazer?</h4>";
                                        echo "<p>Não se preocupe, informaremos em algumas horas por e-mail se foi aprovado.</p>";
                                    ?>
                                </div>
                            </div>
                        </div>
